/// Performs conversion between hiragana and romaji.
///
/// Supports 'wapuro' style romaji only.
///
/// Hepburn and other romanization schemes will not be supported,
/// because they do not adequately represent written language.
...
///
/// romaji::from_romaji("daigakuinhasuggokutaihendatta");
/// ```
...
///
/// Irregular usage of hiragana may not result in desired results.
///
/// # Examples
///
/// ```
